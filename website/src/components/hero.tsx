...
export default function Hero() {
  return (
    <section className="mb-12 md:mb-2">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center justify-center mx-auto min-h-[70vh] md:min-h-[80vh] max-w-[1300px] px-6 pt-4">
